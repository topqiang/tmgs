...
use Merchant\Model\AuthRuleModel;
...
//         dump($menus);
    ...
    {
        return M('merchant_advertising')->where(array('type'=>$type))->field('id,money,location,type')->select();
    }
    ...
    {
        return M('Article')->where(array('id'=>$id))->field('title,cn_content')->find();
    }

    /**
     * 写日志
     */
    function addPayLog($data=array())
    {
