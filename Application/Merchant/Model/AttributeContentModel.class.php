...
class AttributeContentModel extends BaseModel {
    ...
    protected $_validate = array (
        array('cn_attr_con_name', 'require', '中文属性值必须填写', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('cn_attr_con_name', '1,50', '中文属性值长度不能超过50个字符', self::MUST_VALIDATE, 'length', self::MODEL_BOTH),
    );
