...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/home/wwwroot/2.taomim.com/ThinkPHP/Library/Vendor/Unionpay/tmgs.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '123456';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/home/wwwroot/2.taomim.com/ThinkPHP/Library/Vendor/Unionpay/acp_prod_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/home/wwwroot/2.taomim.com/ThinkPHP/Library/Vendor/Unionpay/';
...
const SDK_BACK_NOTIFY_URL = 'http://2.taomim.com/index.php/Api/Test/unionPayNotify';

//文件下载目录
const SDK_FILE_DOWN_PATH = '/home/wwwroot/2.taomim.com/file/';

//日志 目录
const SDK_LOG_FILE_PATH = '/home/wwwroot/2.taomim.com/logs/';
